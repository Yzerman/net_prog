...
// 
namespace PhoneAppUnitTests.ServiceReference1 {
    ...
    public interface IPSRemoting {
        ...
        System.IAsyncResult BegininvokeCommand(PhoneAppUnitTests.ServiceReference1.PSRequest datainput, System.AsyncCallback callback, object asyncState);
        
        PhoneAppUnitTests.ServiceReference1.PSResponse EndinvokeCommand(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPSRemotingChannel : PhoneAppUnitTests.ServiceReference1.IPSRemoting, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class invokeCommandCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public PhoneAppUnitTests.ServiceReference1.PSResponse Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((PhoneAppUnitTests.ServiceReference1.PSResponse)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PSRemotingClient : System.ServiceModel.ClientBase<PhoneAppUnitTests.ServiceReference1.IPSRemoting>, PhoneAppUnitTests.ServiceReference1.IPSRemoting {
        ...
        System.IAsyncResult PhoneAppUnitTests.ServiceReference1.IPSRemoting.BegininvokeCommand(PhoneAppUnitTests.ServiceReference1.PSRequest datainput, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegininvokeCommand(datainput, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        PhoneAppUnitTests.ServiceReference1.PSResponse PhoneAppUnitTests.ServiceReference1.IPSRemoting.EndinvokeCommand(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegininvokeCommand(object[] inValues, System.AsyncCallback callback, object asyncState) {
            PhoneAppUnitTests.ServiceReference1.PSRequest datainput = ((PhoneAppUnitTests.ServiceReference1.PSRequest)(inValues[0]));
            return ((PhoneAppUnitTests.ServiceReference1.IPSRemoting)(this)).BegininvokeCommand(datainput, callback, asyncState);
        }
        
        private object[] OnEndinvokeCommand(System.IAsyncResult result) {
            PhoneAppUnitTests.ServiceReference1.PSResponse retVal = ((PhoneAppUnitTests.ServiceReference1.IPSRemoting)(this)).EndinvokeCommand(result);
            return new object[] {
                    retVal};
        }
        ...
        public void invokeCommandAsync(PhoneAppUnitTests.ServiceReference1.PSRequest datainput) {
            this.invokeCommandAsync(datainput, null);
        }
        
        public void invokeCommandAsync(PhoneAppUnitTests.ServiceReference1.PSRequest datainput, object userState) {
        ...
        protected override PhoneAppUnitTests.ServiceReference1.IPSRemoting CreateChannel() {
            return new PSRemotingClientChannel(this);
        }
        
        private class PSRemotingClientChannel : ChannelBase<PhoneAppUnitTests.ServiceReference1.IPSRemoting>, PhoneAppUnitTests.ServiceReference1.IPSRemoting {
            
            public PSRemotingClientChannel(System.ServiceModel.ClientBase<PhoneAppUnitTests.ServiceReference1.IPSRemoting> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BegininvokeCommand(PhoneAppUnitTests.ServiceReference1.PSRequest datainput, System.AsyncCallback callback, object asyncState) {
            ...
            public PhoneAppUnitTests.ServiceReference1.PSResponse EndinvokeCommand(System.IAsyncResult result) {
                object[] _args = new object[0];
                PhoneAppUnitTests.ServiceReference1.PSResponse _result = ((PhoneAppUnitTests.ServiceReference1.PSResponse)(base.EndInvoke("invokeCommand", _args, result)));
                return _result;
            }
        }
    }
